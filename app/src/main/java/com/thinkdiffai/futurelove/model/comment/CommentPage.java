...
public class CommentPage {
    ...
    public CommentPage(String location, String avatarUser, String deviceCmt, String diaChiIp, int idComment, long idToanBoSuKien, int idUser, String imageattach, String linkNamGoc, String linkNuGoc, String noiDungCmt, int soThuTuSuKien, String thoiGianRelease, String userName) {
...
//    }
    ...
    public CommentPage(int idUser, String content, String device, long idSummary, int soThuTuSuKien, String diaChiIp, String imageAttach) {
