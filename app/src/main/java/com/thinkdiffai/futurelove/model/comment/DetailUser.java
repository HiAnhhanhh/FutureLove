...
public class DetailUser {
       ...
       private int id_user,count_sukien,count_comment,count_view;

       public DetailUser(String device_register, String email, String ip_register, String link_avatar, String user_name, int id_user, int count_sukien, int count_comment, int count_view) {
